...
public class RAUJANDialog extends javax.swing.JDialog {

    static boolean fals;
    Object[][] data;
    String s, t;

    public RAUJANDialog(java.awt.Frame parent, boolean modal, boolean isFalse) {
        super(parent, modal);
        initComponents();
        ...
        if (fals == true) {
            String sql = "SELECT count(TRANSMETER_ID) FROM bpdb.GENERATION_RAUJAN where TRANSMETER_ID ='" + RAUJANFrame.selectedName + "'";
            ...
            String sq = "select TRANSMETER_ID ,"
                    ...
                    + "SERIAL_NUMBER"
                    + " from bpdb.GENERATION_RAUJAN where TRANSMETER_ID='" + RAUJANFrame.selectedName + "' ";
    ...
    private void initComponents() {
        ...
        m3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "January", "February", "March", "April", "May", "June", "July", "August", "Sptember", "October", "November", "December" }));
...
private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
    ...
    String sql;
    if (fals == false) {
        sql = "INSERT INTO bpdb.GENERATION_RAUJAN VALUES('"
                + m1.getText() + "','"
                + m2.getText() + "','"
                + m3.getSelectedItem() + "','"
                + m4.getSelectedItem() + "','"
        ...
        sql = "update  bpdb.GENERATION_RAUJAN set TRANSMETER_ID='" + m1.getText()
                ...
                + " where TRANSMETER_ID ='" + RAUJANFrame.selectedName + "'";
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RAUJANDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                RAUJANDialog dialog = new RAUJANDialog(new javax.swing.JFrame(), true, true);
