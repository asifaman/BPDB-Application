...
public class RAUJANFrame extends javax.swing.JFrame {

    static Object selectedName;
    Object[][] data;
    private Frame RAUJANFrame;
    ...
    private void initComponents() {
        ...
        employee.setText("POWER GENERATION INFORMATION \"RAUJAN\"");
...
private void searchFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchFieldKeyReleased
    ...
    String sql = "SELECT count(TRANSMETER_ID) FROM bpdb.GENERATION_RAUJAN WHERE "
    ...
    sql = "SELECT * FROM bpdb.GENERATION_RAUJAN WHERE " + searchCol + " LIKE '" + searchField.getText() + "%'";
...
private void RemoveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RemoveButtonActionPerformed
    ...
    if (JOptionPane.showConfirmDialog(this, "are you confirm") == 0) {
        ...
        String sql = "DELETE bpdb.GENERATION_RAUJAN WHERE TRANSMETER_ID = '" + selectedName + "'";
...
private void InsertButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertButtonActionPerformed
    new RAUJANDialog(RAUJANFrame, true, false).setVisible(true);
    Table();
}//GEN-LAST:event_InsertButtonActionPerformed

private void UpdateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateButtonActionPerformed
    selectedName = data[Table.getSelectedRow()][0];
    new RAUJANDialog(RAUJANFrame, true, true).setVisible(true);
    Table();
...
private void searchFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchFieldActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RAUJANFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void Table() {
        ...
        String sql = "SELECT count(TRANSMETER_ID) from bpdb.GENERATION_RAUJAN";
        int Count = Utility2.countQuery(Table, sql);

        data = new Object[Count][10];

        sql = "SELECT * from bpdb.GENERATION_RAUJAN";
