...
public class SHIDDERGANJFrame extends javax.swing.JFrame {

    static Object selectedName;
    Object[][] data;
    private Frame SHIDDERGANJFrame;

    public SHIDDERGANJFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        generation.setFont(new java.awt.Font("Tahoma", 1, 14));
        generation.setForeground(new java.awt.Color(0, 155, 55));
        generation.setText("POWER GENERATION INFORMATION \"SHIDDERGANJ\"");
        ...
        RemoveButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/cancel e.png"))); // NOI18N
        RemoveButton.setText("Remove");
        RemoveButton.setMaximumSize(new java.awt.Dimension(101, 33));
        RemoveButton.setMinimumSize(new java.awt.Dimension(101, 33));
        ...
        InsertButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/add f.png"))); // NOI18N
        ...
        UpdateButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/edit f.png"))); // NOI18N
        ...
        HRPanelLayout.setHorizontalGroup(
            ...
            .addGroup(HRPanelLayout.createSequentialGroup()
                .addGap(73, 73, 73)
                .addComponent(generation, javax.swing.GroupLayout.PREFERRED_SIZE, 413, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        HRPanelLayout.setVerticalGroup(
            ...
            .addGroup(HRPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(generation, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(32, 32, 32)
...
private void searchFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchFieldKeyReleased
    ...
    String sql = "SELECT count(TRANSMETER_ID) FROM bpdb.GENERATION_SHIDDERGANJ WHERE "
            + searchCol + " LIKE '" + searchField.getText() + "%'";
    count =
            Utility2.countQuery(searchField, sql);
    data = new Object[count][10];
    sql = "SELECT * FROM bpdb.GENERATION_SHIDDERGANJ WHERE " + searchCol + " LIKE '" + searchField.getText() + "%'";
...
private void RemoveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RemoveButtonActionPerformed
    ...
    if (JOptionPane.showConfirmDialog(this, "are you confirm") == 0) {
        ...
        String sql = "DELETE bpdb.GENERATION_SHIDDERGANJ WHERE TRANSMETER_ID = '" + selectedName + "'";
...
private void InsertButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertButtonActionPerformed
    new SHIDDERGANJDialog(SHIDDERGANJFrame, true, false).setVisible(true);
    Table();
}//GEN-LAST:event_InsertButtonActionPerformed

private void UpdateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateButtonActionPerformed
    selectedName = data[Table.getSelectedRow()][0];
    new SHIDDERGANJDialog(SHIDDERGANJFrame, true, true).setVisible(true);
    Table();
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SHIDDERGANJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void Table() {
        ...
        String sql = "SELECT count(TRANSMETER_ID) from bpdb.GENERATION_SHIDDERGANJ";
        int Count = Utility2.countQuery(Table, sql);

        data = new Object[Count][10];

        sql = "SELECT * from bpdb.GENERATION_SHIDDERGANJ";
