...
public class DHAKAFrame extends javax.swing.JFrame {

    static Object selectedName;
    Object[][] data;
    private Frame DHAKAFrame;
    ...
    private void initComponents() {
        ...
        employee.setText("POWER GENERATION INFORMATION \"DHAKA\"");
...
private void searchFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchFieldKeyReleased
    ...
    String sql = "SELECT count(TRANSMETER_ID) FROM bpdb.GENERATION_DHAKA WHERE "
    ...
    sql = "SELECT * FROM bpdb.GENERATION_DHAKA WHERE " + searchCol + " LIKE '" + searchField.getText() + "%'";
...
private void RemoveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RemoveButtonActionPerformed
    ...
    String sql = "DELETE bpdb.GENERATION_DHAKA WHERE TRANSMETER_ID = '" + selectedName + "'";
...
private void InsertButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertButtonActionPerformed
    new DHAKADialog(DHAKAFrame, true, false).setVisible(true);
    Table();
}//GEN-LAST:event_InsertButtonActionPerformed

private void UpdateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateButtonActionPerformed
    selectedName = data[Table.getSelectedRow()][0];
    new DHAKADialog(DHAKAFrame, true, true).setVisible(true);
    Table();
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DHAKAFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void Table() {
        ...
        String sql = "SELECT count(TRANSMETER_ID) from bpdb.GENERATION_DHAKA";
        int Count = Utility2.countQuery(Table, sql);

        data = new Object[Count][10];

        sql = "SELECT * from bpdb.GENERATION_DHAKA";
