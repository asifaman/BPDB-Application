...
public class KHULNAFrame extends javax.swing.JFrame {

    private Frame KHULNAFrame;
    ...
    private void initComponents() {
        ...
        employee.setText("POWER GENERATION INFORMATION \"KHULNA\"");
        ...
        HRPanelLayout.setHorizontalGroup(
            ...
            .addGroup(HRPanelLayout.createSequentialGroup()
                .addGap(99, 99, 99)
                .addComponent(employee, javax.swing.GroupLayout.PREFERRED_SIZE, 343, javax.swing.GroupLayout.PREFERRED_SIZE)
...
private void searchFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchFieldKeyReleased
    ...
    String sql = "SELECT count(TRANSMETER_ID) FROM bpdb.GENERATION_KHULNA WHERE "
    ...
    sql = "SELECT * FROM bpdb.GENERATION_KHULNA WHERE " + searchCol + " LIKE '" + searchField.getText() + "%'";
...
private void RemoveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RemoveButtonActionPerformed
    ...
    if (JOptionPane.showConfirmDialog(this, "are you confirm") == 0) {
        ...
        String sql = "DELETE bpdb.GENERATION_KHULNA WHERE TRANSMETER_ID = '" + selectedName + "'";
...
private void InsertButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertButtonActionPerformed
    new KHULNADialog(KHULNAFrame, true, false).setVisible(true);
    Table();
...
private void UpdateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateButtonActionPerformed
    selectedName = data[Table.getSelectedRow()][0];
    new KHULNADialog(KHULNAFrame, true, true).setVisible(true);
    Table();
...
private void searchFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchFieldActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KHULNAFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void Table() {
        ...
        String sql = "SELECT count(TRANSMETER_ID) from bpdb.GENERATION_KHULNA";
        int Count = Utility2.countQuery(Table, sql);

        data = new Object[Count][10];

        sql = "SELECT * from bpdb.GENERATION_KHULNA";
