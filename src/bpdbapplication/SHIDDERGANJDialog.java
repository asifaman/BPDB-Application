...
public class SHIDDERGANJDialog extends javax.swing.JDialog {

    static boolean fals;
    Object[][] data;
    String s, t;

    public SHIDDERGANJDialog(java.awt.Frame parent, boolean modal, boolean isFalse) {
        super(parent, modal);
        initComponents();
        ...
        if (fals == true) {
            String sql = "SELECT count(TRANSMETER_ID) FROM bpdb.GENERATION_SHIDDERGANJ where TRANSMETER_ID ='" + SHIDDERGANJFrame.selectedName + "'";
            ...
            String sq = "select TRANSMETER_ID ,"
                    ...
                    + "SERIAL_NUMBER"
                    + " from bpdb.GENERATION_SHIDDERGANJ where TRANSMETER_ID='" + SHIDDERGANJFrame.selectedName + "' ";
...
private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
    ...
    String sql;
    if (fals == false) {
        sql = "INSERT INTO bpdb.GENERATION_SHIDDERGANJ VALUES('"
                + m1.getText() + "','"
                + m2.getText() + "','"
                + m3.getSelectedItem() + "','"
                + m4.getSelectedItem() + "','"
        ...
        sql = "update  bpdb.GENERATION_SHIDDERGANJ set TRANSMETER_ID='" + m1.getText()
                ...
                + " where TRANSMETER_ID ='" + SHIDDERGANJFrame.selectedName + "'";
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SHIDDERGANJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                SHIDDERGANJDialog dialog = new SHIDDERGANJDialog(new javax.swing.JFrame(), true, true);
