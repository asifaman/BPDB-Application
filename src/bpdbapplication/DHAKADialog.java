...
public class DHAKADialog extends javax.swing.JDialog {

    static boolean fals;
    Object[][] data;
    String s, t;

    public DHAKADialog(java.awt.Frame parent, boolean modal, boolean isFalse) {
        super(parent, modal);
        initComponents();
        ...
        if (fals == true) {
            String sql = "SELECT count(TRANSMETER_ID) FROM bpdb.GENERATION_DHAKA where TRANSMETER_ID ='" + DHAKAFrame.selectedName + "'";
            ...
            String sq = "select TRANSMETER_ID ,"
                    ...
                    + "SERIAL_NUMBER"
                    + " from bpdb.GENERATION_DHAKA where TRANSMETER_ID='" + DHAKAFrame.selectedName + "' ";
    ...
    private void initComponents() {
        ...
        PanelLayout.setHorizontalGroup(
            ...
            .addGroup(PanelLayout.createSequentialGroup()
                ...
                .addGroup(PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(a14, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(21, 21, 21))
        );
        PanelLayout.setVerticalGroup(
            ...
            .addGroup(PanelLayout.createSequentialGroup()
                ...
                .addGroup(PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(a10)
                    .addComponent(m10, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(PanelLayout.createSequentialGroup()
...
private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
    ...
    String sql;
    if (fals == false) {
        sql = "INSERT INTO bpdb.GENERATION_DHAKA VALUES('"
                + m1.getText() + "','"
                + m2.getText() + "','"
                + m3.getSelectedItem() + "','"
                + m4.getSelectedItem() + "','"
        ...
        sql = "update  bpdb.GENERATION_DHAKA set TRANSMETER_ID='" + m1.getText()
                ...
                + " where TRANSMETER_ID ='" + DHAKAFrame.selectedName + "'";
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DHAKADialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                DHAKADialog dialog = new DHAKADialog(new javax.swing.JFrame(), true, true);
